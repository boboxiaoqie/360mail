...
class RemoveGoodsRoute {
    exec(data, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var connect = yield SqlModel_1.default.instance.getConnect();
            if (connect) {
                var result = yield SqlModel_1.default.instance.removeGoods(connect, data.id);
                if (!result) {
...
exports.default = RemoveGoodsRoute;
//# sourceMappingURL=RemoveGoodsRoute.js.map