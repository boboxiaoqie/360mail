...
class ChangeGoodsSelectRoute {
    exec(data, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var connect = yield SqlModel_1.default.instance.getConnect();
            if (connect) {
                var result = yield SqlModel_1.default.instance.changeGoodsSelected(connect, data.ids, data.selected);
                if (!result) {
...
exports.default = ChangeGoodsSelectRoute;
//# sourceMappingURL=ChangeGoodsSelectRoute.js.map